...
public class Simulatore {
	...
	//3) output di simulazione
	private int nPassi; //T
	private Map<Country,Integer>persone;//per ogni nazione, quanti migranti si sono stanziati
	//Si poteva usare anche la classe countyAndNumber
	
	public Map<Country, Integer> getPersone() {
		return persone;
	}

	//4) stato del mondo simulato
	...
	private void processEvent(Event e) {
		...
		stanziali += migranti % confinanti;//aggiungo i migranti resto della divisione tra stati fra gli stanziali
